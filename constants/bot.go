...
const (
	TimeToday     = "امروز"
	Time1DayAgo   = "۱ روز پیش"
	Time2DaysAgo  = "۲ روز پیش"
	Time3DaysAgo  = "۳ روز پیش"
	Time4DaysAgo  = "۴ روز پیش"
	Time5DaysAgo  = "۵ روز پیش"
	Time6DaysAgo  = "۶ روز پیش"
	Time1WeekAgo  = "یک هفته پیش"
	Time1MonthAgo = "یک ماه پیش"
	Time1YearAgo  = "یک سال پیش"
)
...
// ‌Bot Messages
const (
	WelcomeMsg = `سلام به بات جادویی ما خوش اومدی!🧙🏻‍♂️
مسلما برات سوال که ما چطور میتونیم تو رو به خونه رویاهات نزدیک کنیم!🤔🏠
 خب خیلی ساده به جای این که بری کلی  خونه ببینی و از بین هزاران خونه یکی رو پسند کنی و یه لیست بلند بالا برای خودت بسازی و هر روز بهشون سر بزنی  و....😫فقط کافیه مشخصات خونه ایی که میخوایی رو دست این بات بسپری، این بات با دقت بالا تمام خونه هایی که میتونه شبیه به خونه مدنظرت باشه رو پیدا میکنه و هر روز بهت خبرهای خوبی میده!😍
   خیلی خوب ، اگر برای شروع نیاز کمک داری دکمه راهنمایی رو بزن 🧞‍♂️`
	MenuMsg   = "تو بگو چیکار کنیم !"
	Loading   = " ... اجی مجی"
	NoAdMsg   = "چرا هیچی نیست ؟ 🤔 "
	SearchMsg = "خدمت شما ☺️"
)
